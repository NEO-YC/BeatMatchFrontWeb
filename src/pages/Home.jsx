          ...
          {!isLoggedIn ? (
            ...
            <div className="home-status-card">
              <h3 className="home-status-title">
                היי {profileActive && <span className="pro-badge">PRO</span>} {user?.displayName || "משתמש"} 👋
              </h3>
          ...
          <div className="upgrade-banner-content">
            ...
            <div className="upgrade-banner-text">
              ...
              <div className="upgrade-features">
                ...
                <div className="upgrade-feature">
                  <span className="upgrade-check">✓</span>
                  <span>גישה מלאה ללוח אירועים</span>
                </div>
                <div className="upgrade-feature">
                  <span className="upgrade-check">✓</span>
            ...
            <div className="pro-benefits-grid">
              <div className="pro-benefit-item">
                ...
                <div className="pro-benefit-content">
                  <h4>חשיפה מקסימלית</h4>
                  <p>הופע בראש תוצאות החיפוש</p>
                </div>
              </div>
              <div className="pro-benefit-item">
                <span className="pro-benefit-icon">⚡</span>
                <div className="pro-benefit-content">
                  <h4>תג PRO מיוחד</h4>
                  <p>התבלט עם תג זהב בפרופיל</p>
                </div>
              </div>
              <div className="pro-benefit-item highlight-events">
                <span className="pro-benefit-icon">🎉</span>
                <div className="pro-benefit-content">
                  <h4>לוח אירועים מלא</h4>
                  <p>גישה לכל האירועים המתוכננים</p>
                </div>
              </div>
              <div className="pro-benefit-item">
                <span className="pro-benefit-icon">💎</span>
